...
function generateStringFromCharCode(
  code1,
  code2,
  code3,
  code4,
...
function generateStringFromCodePoint(
  code1,
  code2,
  code3,
  code4,
...
function compareCharCodeAtAndCodePointAt(string, index) {
  ...
  return String(
    `charCodeAt:${charCodeAtResult}, codePointAt:${codePointAtResult}, charAt:${charAtResult}, at: ${atResult}`,
...
console.log(
  'trimString(" 123 ", "middle")',
  trimString(' 123 ', 'middle'),
) // Виведе "Error: side should be either 'start', 'end' or 'both'"
...
console.log(
  'convertCase("abc", "upper")',
  convertCase('abc', 'upper'),
) // Виведе "ABC"
console.log(
  'convertCase("ABC", "lower")',
  convertCase('ABC', 'lower'),
) // Виведе "abc"
console.log(
  'convertCase("abc", "middle")',
  convertCase('abc', 'middle'),
) // Виведе "Error: caseType should be either 'upper' or 'lower'"
